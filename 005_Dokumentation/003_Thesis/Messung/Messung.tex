...
\begin{figure} [H]
  \centering
    \includegraphics[width=0.8\linewidth]{../Bilder/SCR16.PNG}
    \caption{Bild der Störung}
    \label{fig:pd_out_osc}
\end{figure}
\par
\medskip
(sieht mitlerweile leicht anders aus. störungen gehen auch ins negative)
...
Bis zum jetzigen Zeitpunkt konnte somit noch keine eindeutige Ursache für das Verhalten der Amplitude gefunden werden.\par
\medskip
