...
\includepdf[pages={1}, scale=0.8]{KI-Eigenständigkeitserklärung_Nov_2024_Form.pdf}
...
\medskip
Ein großes Dankeschön für das gründliche Korrekturlesen und das hilfreiche Feedback gebührt zudem Ali Mert Ackey, Alicia von Ahlen, Daniel Albinger, Jannik Holland, Melia Keil, Finn Ringelsiep, Julian Scheeler und Jana Vogt.\par
\medskip
...
\begin{table}[h]
    ...
    \begin{tabular}{c|c|c|c|c}
        \textbf{Messmittel} & \textbf{Hersteller} & \textbf{Bezeichung} & \textbf{Gerätenummer} & \textbf{Toleranzen} \\ \hline
...
Dieser Prompt dient der finalen Migration des Projekts auf Hardware-gestützte Frequenzmessung.
